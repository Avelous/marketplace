...
module.exports = async function () {
    if (process.env.UPDATE_SUB_GRAPH) {
        console.log(`updating sub graph...`)
...
async function publishContract(contractName, networkName) {
    try {
        let contract = fs
            .readFileSync(
                `${deploymentsDir}/${networkName}/${contractName}.json`
            )
            .toString()
...
module.exports.tags = ["all", "subgraph"]
